...
import com.example.sa.component.JobScheduleCreator;
import com.example.sa.entity.SchedulerJobInfo;
import com.example.sa.repository.SchedulerRepository;
...
public class SchedulerJobService {
	...
	public void saveOrupdate(SchedulerJobInfo scheduleJob) throws Exception {
		if (scheduleJob.getCronExpression().length() > 0) {
			//scheduleJob.setJobClass(ExchangeRatesJob.class.getName());
